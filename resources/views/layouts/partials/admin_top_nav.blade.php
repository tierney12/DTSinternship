<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header">
        <div class="top-left-part">
            <!-- Logo -->
            <a class="logo" href="//{{ env('APP_HOST') }}">
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)">
                    <img src="//gravatar.com/avatar/{{ md5(Auth::user()->email) }}?d=mm&s=100&size=36"
                ...
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    <li>
                        <div class="dw-user-box">
                            <div class="u-img">
                                <img src="//gravatar.com/avatar/{{ md5(Auth::user()->email) }}?d=mm&s=100&size=80"
                                     alt="Auth::user()->name"/>
                            </div>
                            <div class="u-text">
                    ...
                    <li role="separator" class="divider"></li>
                    <li><a href="{{ route('profile', [], false) }}">Change password</a></li>
                    <li role="separator" class="divider"></li>
                    <li>
            ...
            {{--<li class="dropdown">--}}
                {{--<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)"> <img src="{{ $exampleUser['avatar'] }}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">{{ $exampleUser['firstname'] }} {{ $exampleUser['surname'] }}</b><span class="caret"></span> </a>--}}
                {{--<ul class="dropdown-menu dropdown-user animated flipInY">--}}
                    {{--<li>--}}
                        {{--<div class="dw-user-box">--}}
                            {{--<div class="u-img"><img src="{{ $exampleUser['avatar'] }}" alt="user" /></div>--}}
                            {{--<div class="u-text">--}}
                                {{--<h4>{{ $exampleUser['firstname'] }} {{ $exampleUser['surname'] }}</h4>--}}
{{--                                <p class="text-muted">{{ $exampleUser['email'] }}</p><a href="profile.php" class="btn btn-rounded btn-primary btn-sm">Update Details</a></div>--}}
                        {{--</div>--}}
                    {{--</li>--}}
