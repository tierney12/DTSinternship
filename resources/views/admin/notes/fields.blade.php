...
<div class="col-sm-12 col-lg-12">
    <div class="form-group">
        ...
        <textarea name="note_text" id="note_text" class="form-control"
        >{!! isset($note) ? $note->note_text : old('note_text') !!}</textarea>
    </div>
</div>
    ...
    <div class="col-sm-12">
        <div class="checkbox checkbox-wl">
            ...
            <input id="private"
                   type="checkbox"
                   name="private"
                   value="1" {{ isset($note) ? ($note->private ? 'checked' : '') : '' }}>
...
{{--<div class="col-sm-6">--}}
    {{--<div class="form-group {{ $errors->has('created_by') ? ' has-error' : '' }}">--}}
        ...
        {{--<input name="created_by" id="created_by" class="form-control"--}}
               {{--value="{{ isset($note) ? $note->created_by : old('created_by') }}">--}}
...
{{--<div class="col-sm-6">--}}
    {{--<div class="form-group {{ $errors->has('updated_by') ? ' has-error' : '' }}">--}}
        ...
        {{--<input name="updated_by" id="updated_by" class="form-control"--}}
               {{--value="{{ isset($note) ? $note->updated_by : old('updated_by') }}">--}}
