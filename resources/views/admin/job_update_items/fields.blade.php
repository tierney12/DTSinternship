<div class="col-sm-6">
    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        <input name="name" id="name" class="form-control"
               value="{{ isset($jobUpdateItem) ? $jobUpdateItem->name : old('name') }}">
        @if ($errors->has('name'))
...
{{--<div class="col-sm-6">--}}
    {{--<div class="form-group {{ $errors->has('created_by') ? ' has-error' : '' }}">--}}
        ...
        {{--<input name="created_by" id="created_by" class="form-control"--}}
               {{--value="{{ isset($jobUpdateItem) ? $jobUpdateItem->created_by : old('created_by') }}">--}}
...
{{--<div class="col-sm-6">--}}
    {{--<div class="form-group {{ $errors->has('updated_by') ? ' has-error' : '' }}">--}}
        ...
        {{--<input name="updated_by" id="updated_by" class="form-control"--}}
               {{--value="{{ isset($jobUpdateItem) ? $jobUpdateItem->updated_by : old('updated_by') }}">--}}
