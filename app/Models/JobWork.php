 ...
 * @property \App\Models\CrownBridgeWork crownBridgeWork
 * @property \App\Models\Job job
 * @property \App\Models\ProsWork prosWork
 ...
 * @property integer pros_work_id
 * @property integer crown_bridge_work_id
...
class JobWork extends Model
{
    ...
    protected $casts = [
        'id' => 'integer',
        'job_id' => 'integer',
        'pros_work_id' => 'integer',
        'crown_bridge_work_id' => 'integer',
        'created_by' => 'integer',
        'updated_by' => 'integer'
    ];
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function crownBridgeWork()
    {
        return $this->belongsTo(CrownBridgeWork::class);
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function prosWork()
    {
        return $this->belongsTo(ProsWork::class);
    }
