 ...
 * @property \App\Models\JobsLayout jobsLayout
 ...
 * @property \Illuminate\Database\Eloquent\Collection EstimatesDetail
...
class Estimate extends Model
{
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     **/
    public function jobsLayout()
    {
        return $this->belongsTo(JobsLayout::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function estimatesDetails()
    {
        return $this->hasMany(EstimatesDetail::class);
    }
}
