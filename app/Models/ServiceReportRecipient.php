 ...
 * @property boolean Receives_admin
 * @property boolean Receives_director
 * @property integer created_by
 * @property integer updated_by
 */
class ServiceReportRecipient extends Model
{
    use SoftDeletes, CreateAndUpdateTrait;

    public $table = 'service_report_recipients';
    ...
    protected $casts = [
        ...
        'email' => 'string',
        'active' => 'boolean',
        'Receives_admin' => 'boolean',
        'Receives_director' => 'boolean',
        'created_by' => 'integer',
        'updated_by' => 'integer'
    ];
